...
import com.loginmodule.service.MediaStreamer;
...
//	public static int count = 0;
	...
	public Response uploadFile(		
		...
		if(extension.equalsIgnoreCase("pdf")||extension.equalsIgnoreCase("png")||extension.equalsIgnoreCase("mp4")||extension.equalsIgnoreCase("txt")||extension.equalsIgnoreCase("wmv")||extension.equalsIgnoreCase("flv")) {
			status="not suppoerted format";
		...
		//Let's store the standard data in regular collection
		DBCollection collection = mongoDB.getCollection("SongDetail");
	...
	public Response streamVideo(@HeaderParam("Range") String range,
		...
		MongoClient mongoClient = new MongoClient("localhost", 27017);
		DB mongoDB = mongoClient.getDB("mediadb");
